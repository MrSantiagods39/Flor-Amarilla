...
window.addEventListener('blur', () => {
    ...
    document.title = "Estaras con el otro, no? >:v";
})
    ...
    if (NuevaY < y + AltoTrazo) {
      ...
      function DibujarPetalosTallo() {
        if (CuantosPasos <= Pasos) {
          ...
          DibujarPetalo(500, PetaloY, 15, 2, 300, '#319409', CuantosPasos);
          DibujarPetalo(470, PetaloY2, 15, 2, 300, '#319409', CuantosPasos);
          CuantosPasos++;
  ...
  DibujarTallo();
    ...
    function dibujarSiguientePetalo() {
        if (contadorPetalos <= NumeroPetalos) {
          ...
          DibujarPetalo(x, y, RadioXPetalo, 2, Angulo, '#E4080A', 100);
          contadorPetalos++;
